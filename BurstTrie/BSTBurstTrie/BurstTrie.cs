...
namespace BurstTrie.BSTBurstTrie
{
    public class BurstTrie : ITrie
    {
        ...
        /// </summary>
        public BurstTrie(int containerLimit = 65, char alphabetStart = 'a', char alphabetEnd = 'z')
            : this(Random.Shared, containerLimit, alphabetStart, alphabetEnd) { }

        public BurstTrie(Random rand, int containerLimit = 65, char alphabetStart = 'a', char alphabetEnd = 'z')
        {
            this.Rand = rand;
            ...
            root = new BurstContainer(this) { countOffset = 0 };
        }
